		...
		<div> 
			<div class="">
				<div class="card" >
					...
					Form Pendaftaran Peserta RPL <a href="../media/Lampiran 1-Formulir Pendaftaran Peserta RPL Gizi.docx" download><button src="../media/FORM Konversi nilai.xlsx" class="btn btn-primary btn-sm" style="float: right;">Unduh Berkas <i class="fa fa-download"></i></button></a> </div> <br>
                    <br>
                </div>
			</div>
            <table class="table table-bordered table-striped">
                <thead>			
		  			<tr class="info">
						<th width="5%">No.</th><th>ID </th><th>Nama Lengkap </th><th>Prodi</th><th>Form RPL</th><th width="10%">Aksi</th>
					</tr>
				</thead>
			<?php 
				...
				<tr>
					...
					<td>
						<a href='11_upload.php' class='btn btn-sm btn-primary'><b class='fa fa-upload'> Upload Berkas</b></a>
					</td>
					</tr>
					</table>";
