...
<div id="page-wrapper">
	<div id="page-inner">
		...
		<hr></hr>
		<form method="post" action="09_proses_upload.php" enctype="multipart/form-data">
		<?php 
		...
		<div class="card-body">
			...
			<div class="">
				<label class="card-title">Upload Form Rekomendasi (.docx) <h8 class="text-danger">(File harus di bawah 1 mb)</h8></label>
