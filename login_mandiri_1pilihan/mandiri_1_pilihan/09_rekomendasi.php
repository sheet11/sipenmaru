		...
		<div> 
			<div class="">
				<div class="card" >
					...
					Form Rekomendasi <a href="../media/surat Rekomendasi.docx" download><button src="../media/surat Rekomendasi.docx" class="btn btn-primary btn-sm" style="float: right;">Unduh Berkas <i class="fa fa-download"></i></button></a> </div> <br>
                    <br>
                    <br>
                </div>
			</div>
			...
			<?php 
				...
				<tr>
					...
					<td>";
						...
						echo"</td>                        
					<td>
						<a href='09_upload.php' class='btn btn-sm btn-primary'><b class='fa fa-upload'> Upload Berkas</b></a>
					</td>
					</tr>
					</table>";
