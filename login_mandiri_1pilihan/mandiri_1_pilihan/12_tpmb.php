		...
		<div>
			<div class="">
				<div class="card">
					...
					<div class="card-body" style="max-width: 290px;">
						Penjelasan Persyaratan<a href="../media/PENJELASAN PERSYARATAN DOKUMEN PORTOFOLIO RPL.docx" download><button src="../media/DAFTAR RIWAYAT HIDUP.docx" class="btn btn-primary btn-sm" style="float: right;">Unduh Berkas <i class="fa fa-download"></i></button></a>
					</div> <br>
					<div class="card-body" style="max-width: 290px;">
				...
				<tr>
					...
					<tr>
						<td>
							...
							2. form persyaratan sebagai acuan apa saja yang harus d upload</br>
							3. Dokumen-dokumen yang sudah di upload di sistem ini silahkan di upload lagi ke google drive <br>
							4. Lengkapi semua persyaratan yang tertera kemudian upload ke google drive pribadi dan input link google tersebut dengan cara klik edit</br>
						</td>
					</tr>
				</table>
			</div>
