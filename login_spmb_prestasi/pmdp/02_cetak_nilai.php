	...
	<body>
		<table class="table">
			<tr >
		    	...
		    	<td align="center"><strong>Seleksi Penerimaan Mahasiswa Baru (SIPENMARU)</br>PENDIDIKAN TENAGA KESEHATAN <br>Poltekkes Kemenkes Bengkulu Tahun <?php echo date('Y') . '/' . (date('Y') + 1); ?></strong></td>
		...
		<table class="table table-bordered">
			...
			<tr>
				...
				// Semester 1
				if (!empty($satu['peng_agama'])) {
					$peng1a = 1;
				} else {
					$peng1a = 0;
				}
				if (!empty($satu['peng_kewarganegaraan'])) {
					$peng1b = 1;
				} else {
					$peng1b = 0;
				}
				if (!empty($satu['peng_bahasa_indonesia'])) {
					$peng1c = 1;
				} else {
					$peng1c = 0;
				}
				if (!empty($satu['peng_bahasa_inggris'])) {
					$peng1d = 1;
				} else {
					$peng1d = 0;
				}
				if (!empty($satu['peng_matematika'])) {
					$peng1e = 1;
				} else {
					$peng1e = 0;
				}
				if (!empty($satu['peng_fisika'])) {
					$peng1f = 1;
				} else {
					$peng1f = 0;
				}
				if (!empty($satu['peng_biologi'])) {
					$peng1g = 1;
				} else {
					$peng1g = 0;
				}
				if (!empty($satu['peng_kimia'])) {
					$peng1h = 1;
				} else {
					$peng1h = 0;
				}
				if (!empty($satu['peng_sejarah'])) {
					$peng1i = 1;
				} else {
					$peng1i = 0;
				}
				if (!empty($satu['peng_geografi'])) {
					$peng1j = 1;
				} else {
					$peng1j = 0;
				}
				if (!empty($satu['peng_ekonomi'])) {
					$peng1k = 1;
				} else {
					$peng1k = 0;
				}
				if (!empty($satu['peng_sosiologi'])) {
					$peng1l = 1;
				} else {
					$peng1l = 0;
				}
				if (!empty($satu['peng_senibudaya'])) {
					$peng1m = 1;
				} else {
					$peng1m = 0;
				}
				if (!empty($satu['peng_pend_jasmani'])) {
					$peng1n = 1;
				} else {
					$peng1n = 0;
				}
				if (!empty($satu['peng_teknologi_informasi'])) {
					$peng1o = 1;
				} else {
					$peng1o = 0;
				}
				if (!empty($satu['peng_keterampilan'])) {
					$peng1p = 1;
				} else {
					$peng1p = 0;
				}
				if (!empty($satu['peng_mulok'])) {
					$peng1q = 1;
				} else {
					$peng1q = 0;
				}
				...
				// Semester 2
				if (!empty($dua['peng_agama'])) {
					$peng2a = 1;
				} else {
					$peng2a = 0;
				}
				if (!empty($dua['peng_kewarganegaraan'])) {
					$peng2b = 1;
				} else {
					$peng2b = 0;
				}
				if (!empty($dua['peng_bahasa_indonesia'])) {
					$peng2c = 1;
				} else {
					$peng2c = 0;
				}
				if (!empty($dua['peng_bahasa_inggris'])) {
					$peng2d = 1;
				} else {
					$peng2d = 0;
				}
				if (!empty($dua['peng_matematika'])) {
					$peng2e = 1;
				} else {
					$peng2e = 0;
				}
				if (!empty($dua['peng_fisika'])) {
					$peng2f = 1;
				} else {
					$peng2f = 0;
				}
				if (!empty($dua['peng_biologi'])) {
					$peng2g = 1;
				} else {
					$peng2g = 0;
				}
				if (!empty($dua['peng_kimia'])) {
					$peng2h = 1;
				} else {
					$peng2h = 0;
				}
				if (!empty($dua['peng_sejarah'])) {
					$peng2i = 1;
				} else {
					$peng2i = 0;
				}
				if (!empty($dua['peng_geografi'])) {
					$peng2j = 1;
				} else {
					$peng2j = 0;
				}
				if (!empty($dua['peng_ekonomi'])) {
					$peng2k = 1;
				} else {
					$peng2k = 0;
				}
				if (!empty($dua['peng_sosiologi'])) {
					$peng2l = 1;
				} else {
					$peng2l = 0;
				}
				if (!empty($dua['peng_senibudaya'])) {
					$peng2m = 1;
				} else {
					$peng2m = 0;
				}
				if (!empty($dua['peng_pend_jasmani'])) {
					$peng2n = 1;
				} else {
					$peng2n = 0;
				}
				if (!empty($dua['peng_teknologi_informasi'])) {
					$peng2o = 1;
				} else {
					$peng2o = 0;
				}
				if (!empty($dua['peng_keterampilan'])) {
					$peng2p = 1;
				} else {
					$peng2p = 0;
				}
				if (!empty($dua['peng_mulok'])) {
					$peng2q = 1;
				} else {
					$peng2q = 0;
				}
				...
				// Semester 3
				if (!empty($tiga['peng_agama'])) {
					$peng3a = 1;
				} else {
					$peng3a = 0;
				}
				if (!empty($tiga['peng_kewarganegaraan'])) {
					$peng3b = 1;
				} else {
					$peng3b = 0;
				}
				if (!empty($tiga['peng_bahasa_indonesia'])) {
					$peng3c = 1;
				} else {
					$peng3c = 0;
				}
				if (!empty($tiga['peng_bahasa_inggris'])) {
					$peng3d = 1;
				} else {
					$peng3d = 0;
				}
				if (!empty($tiga['peng_matematika'])) {
					$peng3e = 1;
				} else {
					$peng3e = 0;
				}
				if (!empty($tiga['peng_fisika'])) {
					$peng3f = 1;
				} else {
					$peng3f = 0;
				}
				if (!empty($tiga['peng_biologi'])) {
					$peng3g = 1;
				} else {
					$peng3g = 0;
				}
				if (!empty($tiga['peng_kimia'])) {
					$peng3h = 1;
				} else {
					$peng3h = 0;
				}
				if (!empty($tiga['peng_sejarah'])) {
					$peng3i = 1;
				} else {
					$peng3i = 0;
				}
				if (!empty($tiga['peng_geografi'])) {
					$peng3j = 1;
				} else {
					$peng3j = 0;
				}
				if (!empty($tiga['peng_ekonomi'])) {
					$peng3k = 1;
				} else {
					$peng3k = 0;
				}
				if (!empty($tiga['peng_sosiologi'])) {
					$peng3l = 1;
				} else {
					$peng3l = 0;
				}
				if (!empty($tiga['peng_senibudaya'])) {
					$peng3m = 1;
				} else {
					$peng3m = 0;
				}
				if (!empty($tiga['peng_pend_jasmani'])) {
					$peng3n = 1;
				} else {
					$peng3n = 0;
				}
				if (!empty($tiga['peng_teknologi_informasi'])) {
					$peng3o = 1;
				} else {
					$peng3o = 0;
				}
				if (!empty($tiga['peng_keterampilan'])) {
					$peng3p = 1;
				} else {
					$peng3p = 0;
				}
				if (!empty($tiga['peng_mulok'])) {
					$peng3q = 1;
				} else {
					$peng3q = 0;
				}
				...
				// Semester 4
				if (!empty($empat['peng_agama'])) {
					$peng4a = 1;
				} else {
					$peng4a = 0;
				}
				if (!empty($empat['peng_kewarganegaraan'])) {
					$peng4b = 1;
				} else {
					$peng4b = 0;
				}
				if (!empty($empat['peng_bahasa_indonesia'])) {
					$peng4c = 1;
				} else {
					$peng4c = 0;
				}
				if (!empty($empat['peng_bahasa_inggris'])) {
					$peng4d = 1;
				} else {
					$peng4d = 0;
				}
				if (!empty($empat['peng_matematika'])) {
					$peng4e = 1;
				} else {
					$peng4e = 0;
				}
				if (!empty($empat['peng_fisika'])) {
					$peng4f = 1;
				} else {
					$peng4f = 0;
				}
				if (!empty($empat['peng_biologi'])) {
					$peng4g = 1;
				} else {
					$peng4g = 0;
				}
				if (!empty($empat['peng_kimia'])) {
					$peng4h = 1;
				} else {
					$peng4h = 0;
				}
				if (!empty($empat['peng_sejarah'])) {
					$peng4i = 1;
				} else {
					$peng4i = 0;
				}
				if (!empty($empat['peng_geografi'])) {
					$peng4j = 1;
				} else {
					$peng4j = 0;
				}
				if (!empty($empat['peng_ekonomi'])) {
					$peng4k = 1;
				} else {
					$peng4k = 0;
				}
				if (!empty($empat['peng_sosiologi'])) {
					$peng4l = 1;
				} else {
					$peng4l = 0;
				}
				if (!empty($empat['peng_senibudaya'])) {
					$peng4m = 1;
				} else {
					$peng4m = 0;
				}
				if (!empty($empat['peng_pend_jasmani'])) {
					$peng4n = 1;
				} else {
					$peng4n = 0;
				}
				if (!empty($empat['peng_teknologi_informasi'])) {
					$peng4o = 1;
				} else {
					$peng4o = 0;
				}
				if (!empty($empat['peng_keterampilan'])) {
					$peng4p = 1;
				} else {
					$peng4p = 0;
				}
				if (!empty($empat['peng_mulok'])) {
					$peng4q = 1;
				} else {
					$peng4q = 0;
				}
				...
				// Semester 5
				if (!empty($lima['peng_agama'])) {
					$peng5a = 1;
				} else {
					$peng5a = 0;
				}
				if (!empty($lima['peng_kewarganegaraan'])) {
					$peng5b = 1;
				} else {
					$peng5b = 0;
				}
				if (!empty($lima['peng_bahasa_indonesia'])) {
					$peng5c = 1;
				} else {
					$peng5c = 0;
				}
				if (!empty($lima['peng_bahasa_inggris'])) {
					$peng5d = 1;
				} else {
					$peng5d = 0;
				}
				if (!empty($lima['peng_matematika'])) {
					$peng5e = 1;
				} else {
					$peng5e = 0;
				}
				if (!empty($lima['peng_fisika'])) {
					$peng5f = 1;
				} else {
					$peng5f = 0;
				}
				if (!empty($lima['peng_biologi'])) {
					$peng5g = 1;
				} else {
					$peng5g = 0;
				}
				if (!empty($lima['peng_kimia'])) {
					$peng5h = 1;
				} else {
					$peng5h = 0;
				}
				if (!empty($lima['peng_sejarah'])) {
					$peng5i = 1;
				} else {
					$peng5i = 0;
				}
				if (!empty($lima['peng_geografi'])) {
					$peng5j = 1;
				} else {
					$peng5j = 0;
				}
				if (!empty($lima['peng_ekonomi'])) {
					$peng5k = 1;
				} else {
					$peng5k = 0;
				}
				if (!empty($lima['peng_sosiologi'])) {
					$peng5l = 1;
				} else {
					$peng5l = 0;
				}
				if (!empty($lima['peng_senibudaya'])) {
					$peng5m = 1;
				} else {
					$peng5m = 0;
				}
				if (!empty($lima['peng_pend_jasmani'])) {
					$peng5n = 1;
				} else {
					$peng5n = 0;
				}
				if (!empty($lima['peng_teknologi_informasi'])) {
					$peng5o = 1;
				} else {
					$peng5o = 0;
				}
				if (!empty($lima['peng_keterampilan'])) {
					$peng5p = 1;
				} else {
					$peng5p = 0;
				}
				if (!empty($lima['peng_mulok'])) {
					$peng5q = 1;
				} else {
					$peng5q = 0;
				}
