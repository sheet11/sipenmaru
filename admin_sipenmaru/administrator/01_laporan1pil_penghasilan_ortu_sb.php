            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <?php foreach ($penghasilan_list as $header_label => $nilai_values): 
                        ...
                        if ($prodi_value === "") {
                            $query = mysqli_query($kon, "SELECT 1 FROM tb_formulir5 WHERE status='Sudah Membayar' AND $kondisi_penghasilan AND tahun_pendaftaran='2026'");
                        } else {
                            $query = mysqli_query($kon, "SELECT 1 FROM tb_formulir5 WHERE pilihan_prodi = '$prodi_value' AND status='Sudah Membayar' AND $kondisi_penghasilan AND tahun_pendaftaran='2026'");
                        }
