        ...
        <div class="container-fluid" style="margin:10px;">
            ...
            <table class="table table-bordered">
                <tr style="text-align:center">
                    ...
                    <th colspan="<?= count($pekerjaan_list) ?>">Pekerjaan Ibu</th>
                </tr>
                <tr style="text-align:center">
                ...
                foreach ($prodi_list as $label => $prodi_value): ?>
                    <tr>
                        ...
                        <?php foreach ($pekerjaan_list as $pekerjaan):
                            if ($prodi_value === "") {
                                $query = mysqli_query($kon, "SELECT 1 FROM tb_formulir3 WHERE pekerjaan_orang_tua_ibu = '$pekerjaan'");
                            } else {
                                $query = mysqli_query($kon, "SELECT 1 FROM tb_formulir3 WHERE pilihan_prodi = '$prodi_value' AND pekerjaan_orang_tua_ibu = '$pekerjaan'");
                            }
