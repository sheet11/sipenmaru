...
<aside class="right-side">
    <section class="content-header">
        ...
        <table style="width:100%;">
            <tr class="info">
            <td align="left" colspan="6"><b><h4>Daftar Calon Mahasiswa Baru 2 Pilihan Mandiri Gelombang III</b></h4></td>   
            ...
            <tr>
                <td width="20%"><label>Pencarian Berdasarkan</label></td>               
	                ...
	                <td>
	                    <a href="081_daftar_calon_mahasiswa.php" class="btn btn-primary">ALL</a>
	                </td>                   
            </tr>
            <tr>
                <td><a href="1_gelombang3_jumlah.php" class="btn btn-info" > Jumlah: <?php
...
ini_set('display_errors', 0);
                ...
                <td>
                    ...
                    {
                    ?>
                        <a class="btn btn-success" href="1_cetak_excel_gel3.php">Cetak Excel</a>
                    <?php
                    }
                    ?>
                </td>
...
ini_set('display_errors', 0);
                if(isset($_POST['submit'])){
                    $cariid = $_POST['cariid'];
                    $cari = $_POST['cari'];
                    $query=mysqli_query($kon,"select * from tb_formulir4 where (status='Sudah Membayar' and level='MANDIRI 2 PILIHAN GEL III') and $cariid = '$cari' or $cariid = '0' "); 
                    $i = $posisi+1;      
            ...
            echo"
                ...
                elseif(!empty($_GET['username'])){
                    $query=mysqli_query($kon,"select * from tb_formulir4 where (status='Sudah Membayar' and level='MANDIRI 2 PILIHAN GEL III') and username='$_GET[username]'"); 
                    $i = $posisi+1;      
                while($a=mysqli_fetch_array($query)){
            echo"
                <tr>    
                ...
                $i++;
                    ...
                    $query=mysqli_query($kon,"select * from tb_formulir4 where status='Sudah Membayar' and level='MANDIRI 2 PILIHAN GEL III' order by username asc  LIMIT $posisi,$batas");
    ...
    $jmldata = mysqli_num_rows(mysqli_query($kon,"SELECT * FROM tb_formulir4 where status='Sudah Membayar' and level='MANDIRI 2 PILIHAN GEL III'"));
