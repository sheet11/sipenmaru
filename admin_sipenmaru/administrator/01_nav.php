        ...
        <li class="treeview">
          ...
          <ul class="treeview-menu">
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="01_laporan_1pilihan_gelombang2_seluruh.php"><i class="fa fa-circle-o"></i>All</a></li>
                ...
                <li><a href="01_tingkat_prodi_1pil_mandiri.php"><i class="fa fa-circle-o"></i>Tingkat Prodi</a></li> -->
                    ...
                    <li><a href="01_laporan_keterangan_sekolah_1pil_mandiri.php"><i
                          class="fa fa-circle-o"></i>Keterangan Sekolah</a></li>
                ...
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    ...
                    <li><a href="01_jenis_kelamin_1pil_mandiri_sb.php"><i class="fa fa-circle-o"></i>Jenis Kelamin</a>
                    </li>
                    <li><a href="01_laporan_asal_sekolah_1pil_mandiri_sb.php"><i class="fa fa-circle-o"></i>Asal
                        Sekolah</a></li>
                    <li><a href="01_laporan_keterangan_sekolah_1pil_mandiri_sb.php"><i
                          class="fa fa-circle-o"></i>Keterangan Sekolah</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li class="treeview">
                  ...
                  <ul class="treeview-menu">
                    <li><a href="01_laporan_2pilihan_gelombang2_seluruh.php"><i class="fa fa-circle-o"></i>All</a></li>
                    <li><a href="01_laporan_2pilihan_gelombang2.php"><i class="fa fa-circle-o"></i>Sudah Membayar</a>
                    </li>
                ...
                <li><a href="01_tingkat_prodi_2pil_mandiri.php"><i class="fa fa-circle-o"></i>Tingkat Prodi</a></li> -->
                    ...
                    <li><a href="01_laporan_asal_sekolah_2pil_mandiri.php"><i class="fa fa-circle-o"></i>Asal
                        Sekolah</a></li>
                    <li><a href="01_laporan_keterangan_sekolah_2pil_mandiri.php"><i
                          class="fa fa-circle-o"></i>Keterangan Sekolah</a></li>
                    <li><a href="01_laporan2pil_pekerjaan.php"><i class="fa fa-circle-o"></i>Pekerjaan Orang Tua</a>
                    </li>
                    <li><a href="01_laporan2pil_penghasilan_ortu.php"><i class="fa fa-circle-o"></i>Penghasilan Orang
                        Tua</a></li>
                    <li><a href="cetak_lulus_tahap2.php"><i class="fa fa-circle-o"></i>Cetak Excel kelulusan tahap
                        II</a></li>
            ...
            <li class="treeview">
              ...
              <ul class="treeview-menu">
                <li><a href="10_daftar_calon_mahasiswa_internasional.php"><i class="fa fa-circle-o"></i>Pendaftar</a>
                </li>
                <li><a href="10_jumlah_pendaftar_internasional.php"><i class="fa fa-circle-o"></i>Jumlah Pendaftar</a>
                </li>
              </ul>
            </li>
