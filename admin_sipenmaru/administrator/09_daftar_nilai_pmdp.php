...
<aside class="right-side">
    <section class="content-header">
        <div class="container-fluid" style="margin:10px; overflow:auto;">  
        <table style="width:100%;">
            ...
            <tr>
                <td width="20%"><label>Pencarian Berdasarkan</label></td>               
                    ...
                    <td>
                        <a href="09_daftar_nilai_pmdp.php" class="btn btn-primary">ALL</a>
                    </td>                   
            </tr>
            <tr>
            ...
            <tr>
                <td>
                    ...
                    if(isset($_POST['submit']))
                    {
                        ...
                        $cari = $_POST['cari'];
                    ?>
                        <a class="btn btn-info" href="09_cetak_excel_calon_mahasiswa_pmdp.php?cariid=<?php echo $cariid; ?>&cari=<?php echo $cari; ?>">Cetak Excel</a>
                    <?php
                    }
                    elseif(!empty($_GET['username']))
                    {
                    ?>
                        <a class="btn btn-info" href="09_cetak_excel_calon_mahasiswa_pmdp.php?username=<?php echo $_GET['username']; ?>">Cetak Excel</a>
                    <?php
                    }
                    else
                    {
                    ?>
                        <a class="btn btn-info" href="09_cetak_excel_calon_mahasiswa_pmdp.php">Cetak Excel</a>
                    <?php
                    }
                    ?>
                </td>
