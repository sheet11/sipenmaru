        ...
        <div class="container-fluid" style="margin:10px;">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <?php foreach ($pekerjaan_list as $pekerjaan): 
                        if ($prodi_value === "") {
                            $query = mysqli_query($kon, "SELECT 1 FROM tb_formulir4 WHERE pekerjaan_orang_tua = '$pekerjaan'");
                        } else {
                            $query = mysqli_query($kon, "SELECT 1 FROM tb_formulir4 WHERE pilihan_prodi = '$prodi_value' AND pekerjaan_orang_tua = '$pekerjaan'");
                        }
