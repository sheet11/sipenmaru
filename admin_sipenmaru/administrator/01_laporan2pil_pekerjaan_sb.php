            ...
            <table class="table table-bordered">
                ...
                <tr>
                    ...
                    <?php foreach ($pekerjaan_list as $pekerjaan_label => $pekerjaan_values): 
                        ...
                        if ($prodi_value === "") {
                            $query = mysqli_query($kon, "SELECT 1 FROM tb_formulir4 WHERE status='Sudah Membayar' AND pekerjaan_orang_tua IN ($in_values) AND tahun_pendaftaran='2026'");
                        } else {
                            $query = mysqli_query($kon, "SELECT 1 FROM tb_formulir4 WHERE pilihan_prodi = '$prodi_value' AND status='Sudah Membayar' AND pekerjaan_orang_tua IN ($in_values) AND tahun_pendaftaran='2026'");
                        }
