        ...
        <div class="container-fluid" style="margin:10px;">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>-</td>
                    <td><b>Pendaftar</b></td>
                    <td><b><?php echo getCount($kon, "status='Sudah Membayar' AND keterangan_sekolah = 'Dalam Kota Bengkulu' AND tahun_pendaftaran='2026'"); ?></b>
                    </td>
                    <td><b><?php echo getCount($kon, "status='Sudah Membayar' AND keterangan_sekolah = 'Luar Kota Bengkulu' AND tahun_pendaftaran='2026'"); ?></b>
                    </td>
                    <td><b><?php echo getCount($kon, "status='Sudah Membayar' AND keterangan_sekolah = 'Luar Provinsi Bengkulu' AND tahun_pendaftaran='2026'"); ?></b>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><?php echo getCount($kon, "status='Sudah Membayar' AND pilihan_prodi='$prodi' AND keterangan_sekolah='Dalam Kota Bengkulu' AND tahun_pendaftaran='2026'"); ?>
                    </td>
                    <td><?php echo getCount($kon, "status='Sudah Membayar' AND pilihan_prodi='$prodi' AND keterangan_sekolah='Luar Kota Bengkulu' AND tahun_pendaftaran='2026'"); ?>
                    </td>
                    <td><?php echo getCount($kon, "status='Sudah Membayar' AND pilihan_prodi='$prodi' AND keterangan_sekolah='Luar Provinsi Bengkulu' AND tahun_pendaftaran='2026'"); ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
