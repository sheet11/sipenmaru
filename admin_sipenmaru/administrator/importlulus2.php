    ...
    <div class="container-fluid">
      ...
      <div class="row">
        ...
        <div class="col-xs-7 col-md-7 col-sm-6 col-lg-7">
            ...
            <a href="format import kelulusan 2.xlsx" class="btn btn-primary btn-sm"><i class="fa da-download"></i> Download Format</a>
        </div>
 ...
 if(in_array($extension, $allowed_extension)) //check selected file extension is present in allowed extension array
 {
  ...
  foreach ($objPHPExcel->getWorksheetIterator() as $worksheet)
  {
   ...
   for($row=2; $row<=$highestRow; $row++)
   {
    ...
    $status_pmdp2 = trim(mysqli_real_escape_string($kon, $worksheet->getCellByColumnAndRow(2, $row)->getValue())," ");
