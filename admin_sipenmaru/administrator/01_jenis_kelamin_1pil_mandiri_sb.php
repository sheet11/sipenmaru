        ...
        <div class="container-fluid" style="margin:10px;">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td>-</td>
                    <td><b>Pendaftar</b></td>
                    <td><b><?php echo getCount($kon, "status='Sudah Membayar' AND jenis_kelamin='Laki-Laki' AND tahun_pendaftaran='2026'"); ?></b>
                    </td>
                    <td><b><?php echo getCount($kon, "status='Sudah Membayar' AND jenis_kelamin='Perempuan' AND tahun_pendaftaran='2026'"); ?></b>
                    </td>
                </tr>
                ...
                <tr>
                    ...
                    <td><?php echo getCount($kon, "status='Sudah Membayar' AND pilihan_prodi='$prodi' AND jenis_kelamin='Laki-Laki' AND tahun_pendaftaran='2026'"); ?>
                    </td>
                    <td><?php echo getCount($kon, "status='Sudah Membayar' AND pilihan_prodi='$prodi' AND jenis_kelamin='Perempuan' AND tahun_pendaftaran='2026'"); ?>
                    </td>
                </tr>
                <?php endforeach; ?>
            </table>
