        ...
        <table style="width:100%;">
            ...
            <tr>
                <td><a class="btn btn-info" > Jumlah: <?php
                                                                    ...
                                                                    $query = mysqli_query ($kon,"SELECT * from tb_formulir5 where status='Belum Lengkap' ");
        ...
        <table style="width:100%;" class="table table-bordered">    
            ...
            include "../config/koneksi.php";
                if(isset($_POST['submit'])){
                    $cariid = $_POST['cariid'];
                    $cari = $_POST['cari'];
                    $query=mysqli_query($kon,"select * from tb_formulir5 where status='Belum Lengkap' and $cariid = '$cari' or $cariid = '0' "); 
                    $i = $posisi+1;      
            ...
            echo"
                ...
                elseif(!empty($_GET['username'])){
                    $query=mysqli_query($kon,"select * from tb_formulir5 where status='Belum Lengkap' and username='$_GET[username]'"); 
                    $i = $posisi+1;      
                while($a=mysqli_fetch_array($query)){
            echo"
                <tr>    
                ...
                $i++;
                    ...
                    $query=mysqli_query($kon,"select * from tb_formulir5 where status='Belum Lengkap' order by username asc  LIMIT $posisi,$batas");
