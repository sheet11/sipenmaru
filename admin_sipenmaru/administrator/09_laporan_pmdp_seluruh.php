    ...
    <section class="content-header">
        <div class="container-fluid" style="margin:10px;">
            ...
            <table class="table table-bordered">
                ...
                <tr>
                    <td> Jumlah Pendaftar Prodi Sarjana Terapan Keperawatan dan Pendidikan Profesi Ners (Kelas
                        Internasional)</td>
                    <td> :</td>
                    <td><?php
                                                         require_once("../config/koneksi.php");
                ...
                <tr>
                    <td>Jenis Kelamin Perempuan Prodi Sarjana Terapan Keperawatan dan Pendidikan Profesi Ners (Kelas
                        Internasional) </td>
                    <td>:</td>
                    <td><?php
                                                         require_once("../config/koneksi.php");
