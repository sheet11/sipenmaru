...
<html>
  ...
  <table width="60%" border="0"  align="center">
    <tr>
      ...
      <td width="601" align="center"><strong><h4>Seleksi Penerimaan Mahasiswa Baru (SIPENMARU)</br>PENDIDIKAN TENAGA KESEHATAN <br>Poltekkes Kemenkes Bengkulu 2021</h4></strong></td>
    ...
    <tr
      ><td colspan="3"><hr></hr></td>
        ...
        <table width="60%" align="center">
          <tr>
              <td rowspan=14 width=164 valign="top"><a href="../../../simami2021/login_simami/assets/img/<?php echo $a['nama_foto'];?>" class="fancy">
              <img src="../../../simami2021/login_simami/assets/img/<?php echo $a['nama_foto'];?>" alt="" width=150 height=175 border="0" /></td>
          </tr>
    ...
    <table width="60%" border="0" align="center">
        <tr>
          <td colspan=2>Hal- hal yang Harus diperhatikan</td><td align="center">
        </tr>
        <tr>
