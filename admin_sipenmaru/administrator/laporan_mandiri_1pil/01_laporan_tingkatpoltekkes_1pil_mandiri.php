                    ...
                    <table class="table table-bordered">
                        ...
                        <tr>
                            <td>2 </td><td>Peserta Lulus Seleksi Administrasi</td>
                                                        <td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where jenis_kelamin='Laki-Laki' and status_pmdp='LULUS TAHAP 1' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>

                                                         <td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where jenis_kelamin='Perempuan' and status_pmdp='LULUS TAHAP 1' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>

                                                         <td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where status_pmdp='LULUS TAHAP 1' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>
                        </tr>
                        ...
                        <tr>
                            <td>4 </td><td>Peserta yang Lulus Uji Kesehatan</td><td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where jenis_kelamin='Laki-Laki' and status_pmdp_2='LULUS TAHAP 2' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>

                                                         <td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where jenis_kelamin='Perempuan' and status_pmdp_2='LULUS TAHAP 2' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>

                                                        <td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where status_pmdp_2='LULUS TAHAP 2' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>
                        </tr>
                        ...
                        <tr>
                            <td>5 </td><td>Peserta yang Mendaftar Ulang</td><td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where jenis_kelamin='Laki-Laki' and status='0' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>

                                                         <td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where jenis_kelamin='Perempuan' and status='0' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>

                                                         <td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where status='' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>
                        </tr>
                        ...
                        <tr>
                            <td>7 </td><td>Peserta yang Tidak Daftar Ulang</td><td><?php
                                                         ...
                                                         <td><?php
                                                         require_once("../../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where status='0' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>
                        </tr>
