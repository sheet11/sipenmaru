                  ...
                  <table class="table table-bordered">
                        ...
                        <tr>
                            <td> Jenis Kelamin Laki-laki Prodi Pendidikan Profesi Bidan</td> <td> :</td> <td><?php
                                                         require_once("../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where pilihan_prodi='Pendidikan Profesi Bidan' and jenis_kelamin='Laki-Laki' and status='Sudah Membayar' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>
                        </tr>
                        ...
                        <tr>
                            <td> Jenis Kelamin Laki-laki Prodi Sarjana Terapan Kebidanan Alih Jenjang</td> <td> :</td> <td><?php
                                                         require_once("../config/koneksi.php");
                                                         $query = mysqli_query ($kon,"SELECT * FROM tb_formulir5 where pilihan_prodi='Sarjana Terapan Kebidanan Alih Jenjang' and jenis_kelamin='Laki-Laki' and status='Sudah Membayar' ");
                                                         $jumlah= mysqli_num_rows ($query);
                                                         ?><?php echo $jumlah; ?></td>
                        </tr>
                        <tr>
